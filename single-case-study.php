 ...
 * Description: A page template for a single case study
 */
				...
				if (strlen($location)>2){
					...
					if ($ewf_header_image){
						...
						<div class="inner-page-title-container">
							...
							<div id="index-slideshow-wave"></div>
					...
					case "layout-sidebar-single-left": 
							echo '<div class="row fixed">';
								...
								echo '<div class="col-700 last">';
										...
										if (stripos($_SERVER['REQUEST_URI'],'/who-we-are/locations/') !== false) {
											echo do_shortcode('[simplemap]');
										}
